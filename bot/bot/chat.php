...
$questions = [
    ...
    //name
    "como te llamas?" =>"Soy T-Bot y estoy para servirte",
    "cual es tu nombre?" =>"Soy T-Bot y estoy para servirte",
    "tienes nombre?" =>"Soy T-Bot y estoy para servirte",
    "tu nombre?"=>"Soy T-Bot y estoy para servirte",
    "quien te creo?"=>"Fui programada en lenguaje php por Abraham Rivera",
    "quien te creó?"=>"Fui programada en lenguaje php por Abraham Rivera",
    "quien te desarrolló?"=>"Fui programada en lenguaje php por Abraham Rivera",
    "quien te codificó?"=>"Fui programada en lenguaje php por Abraham Rivera",
    ...
    "de donde eres?" => "No tengo nacionalidad definida, pero se podría decir que me crearon en Perú",
    ...
    //
    "what is your name?" =>" my name is T-Bot",
    ...
    //Tsoft
    "que es tsoft?"=>"Es una empresa multinacional conformada por un amplio equipo de profesionales especializados en múltiples tecnologías y con experiencia en diversas metodologías de valor para las áreas claves de IT.",
...
if (isset($_GET['msg'])) {
    ...
    $bot->hears($msg, function (Bot $botty) {
        ...
        if ($msg == 'hi' || $msg == "hello") {
            ...
            $botty->reply("Lo siento, no tengo la capacidad de responder eso :(.");
        } else {
